 ...
 * 
 */
package com.aburgos.projectjpa.dao.impl;
...
public class SubGeneroDAOImpl implements SubGeneroDAO {
	...
	private static final EntityManagerFactory ENTITY_MANAGER_FACTORY = Persistence.createEntityManagerFactory("persistenceABurgos");
